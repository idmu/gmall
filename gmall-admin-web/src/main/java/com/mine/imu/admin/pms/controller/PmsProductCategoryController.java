...
public class PmsProductCategoryController {
    ...
    public Object listWithChildren() {
        //TODO 查询所有一级分类及子分类
         List<PmsProductCategoryWithChildrenItem> items = productCategoryService.getCategoryChildrenList(0);
